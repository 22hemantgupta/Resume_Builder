...
SECRET_KEY = 'kj648=s&xl48##7$=zh775f(%eq9ur-mt@*bssvt8-2286w8(y'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'User',
        'CLIENT': {
            'host': 'mongodb+srv://test:1234@cluster0.vqvin.mongodb.net/myFirstDatabase?retryWrites=true&w=majority',
        }
    }
}
